...
public class addusercontroller extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
       ...
       String panelist=request.getParameter("upanel");
       Boolean panelist_flag;
       ...
       try{
    	 ...
    	 //Password Generation
    	   ...
    	   userd.setUser(user_id, user_name, email, password, date_joined, level, layer, 0, mobile_no, manager_id_1, manager_id_2,panelist_flag,true);
