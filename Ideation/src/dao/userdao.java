...
public void updateUser(String user_id, String user_name, String email,
		...
		String mobile_no, String manager_id_1,
		String manager_id_2, Boolean panelist_flag, String password) throws SQLException
		{
	connection = DatabaseUtility.getConnection();
	preparedStatement = (PreparedStatement) connection
			.prepareStatement("update user set user_name=?,email=?,date_joined=?,level=?,layer=?,mobile_no=?,manager_id_1=?,manager_id_2=?,panelist_flag=?,password=? where user_id=?");
	preparedStatement.setString(11, user_id);
	...
	preparedStatement.setBoolean(9,panelist_flag );
...
public void updateAdmin(String user_id, String user_name, String email,
		Date date_joined, int level, int layer,
		String mobile_no,String password) throws SQLException
		{
	connection = DatabaseUtility.getConnection();
	preparedStatement = (PreparedStatement) connection
			.prepareStatement("update user set user_name=?,email=?,date_joined=?,level=?,layer=?,mobile_no=?,password=? where user_id=?");
